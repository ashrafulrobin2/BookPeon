...
public class SegmentedButtonGroup extends LinearLayout {
    ...
    private void initInterpolations() {
        ArrayList<Class> interpolatorList = new ArrayList<Class>() {{
            add( android.support.v4.view.animation.FastOutSlowInInterpolator.class);
            ...
            add( android.support.v4.view.animation.FastOutLinearInInterpolator.class);
            add( android.support.v4.view.animation.LinearOutSlowInInterpolator.class);
     ...
     *                             Ex: {@link android.support.v4.view.animation.FastOutSlowInInterpolator}, {@link android.view.animation.BounceInterpolator}, {@link android.view.animation.LinearInterpolator}
     */
